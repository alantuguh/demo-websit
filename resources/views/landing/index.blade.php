...
@section('content')
    ...
    {{-- ===================== HERO ===================== --}}
    <section class="position-relative overflow-hidden" id="home" style="background: linear-gradient(360deg, rgba(195, 208, 227, 0.75) 0%,  rgba(174, 191, 218, 0.75) 100%), url('{{ asset('images/lab.jpg') }}'); padding: 110px 0 90px; background-size: cover; background-position: center;">
        <div class="container">
